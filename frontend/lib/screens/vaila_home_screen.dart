...
class _VailaHomeScreenState extends State<VailaHomeScreen>
  ...
  final List<AlphabetItem> _alphabets = [
    AlphabetItem(
        ...
        word: 'Apple',
        speechText: 'aah',
        tip: 'Open your mouth wide and say aaa!'),
    AlphabetItem(
        id: 'b',
        letter: 'b',
        sound: 'buh',
        word: 'Ball',
        speechText: 'buh',
        tip: 'Press your lips together for buh!'),
    AlphabetItem(
        id: 'c',
        letter: 'c',
        sound: 'kuh',
    ...
    AlphabetItem(
        ...
        word: 'Dog',
        speechText: 'dah',
        tip: 'Touch tongue to teeth for dah!'),
    AlphabetItem(
        id: 'e',
        letter: 'e',
        sound: 'eh',
